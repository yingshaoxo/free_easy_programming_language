...
function DefineCommand(cmdFunc: PFN_EXECUTE_CMD; args: array of ARG_INFO;
                       ...
                       shtBitmapIndex: SmallInt = 0; shtBitmapCount: SmallInt = 0) : Integer;
...
procedure DefineHiddenCommand(nRepeatCount: Integer = 1);
...
procedure DefineHiddenMethod(datatypeIndex: Integer; nRepeatCount: Integer = 1);
...
var
  ...
  //关于egdata全局变量的使用, 请参考 DefineLib(), DefineCommand(), DefineConst(), DefineDatatype(), ...
...
begin
  ...
  with egdata do begin
      ...
      //libInfo.m_pCmdsFunc := @@ cmdFuncs[0]; //yeah
...
begin
  for i := 1 to nRepeatCount do begin
    DefineCommand_NoArg(nil, '', '', '', _SDT_NULL, CT_IS_HIDED);
  end;
end;
...
//only used by DefineMethod() and DefineMethod_NoArg()
